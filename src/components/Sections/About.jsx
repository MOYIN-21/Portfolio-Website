...
const About = () => {
  return (
    <section
      id="homehero"
      className="min-h-screen w-full px-4 flex flex-col md:px-10 xl:px-12 space-y-24 items-center py-10 md:pt-48 pt-30"
    >
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row gap-10 md:gap-16 items-start">
        ...
        <div className="relative flex-shrink-0 rounded-2xl overflow-hidden shadow-[0_0_30px_#00C3D0]/50 border-[6px] border-[#1F1F1F] w-80 h-96 mx-auto">
          ...
          <div className="absolute -bottom-4 -left-4 bg-black/90 border border-gray-300 text-white px-5 py-5 rounded-xl shadow-lg text-center">
            <p className="text-2xl text-inter-bold leading-8">5+</p>
