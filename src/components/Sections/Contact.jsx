    ...
    >
      ...
      <div className="grid grid-cols-1 md:pt-48 pt-10 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-6xl">
        {cards.map((card, i) => (
          ...
          >
            ...
            <h3 className="text-xl text-[#FAFAFA] font-semibold">{card.title}</h3>
            ...
            <div className='py-2'> <a href={card.link} target="_blank" rel="noopener noreferrer" > <button className="bg-[#141414] cursor-pointer text-white w-full px-4 py-2 items-center justify-center"> {card.buttonText} </button> </a> </div>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 w-full max-w-6xl pt-10 md:pt-48">
        <div className="flex-1 space-y-4">
          <h3 className="text-2xl text-[#FAFAFA] font-semibold">Send a Message</h3>
          ...
          <form className="space-y-5">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 space-y-2">
                <p className="text-[#FAFAFA] text-sm">Full Name</p>
                <input
                  type="text"
              ...
              <div className="flex-1 space-y-2">
                <p className="text-[#FAFAFA] text-sm">Email Address</p>
                <input
                  type="email"
                  className="border border-[#262626] bg-transparent text-white h-10 w-full rounded-md px-3"
                />
            ...
            <div className='space-y-2'>
              <p className="text-[#FAFAFA] text-sm">Company / Organization</p>
              <input
                type="text"
                className="border border-[#262626] bg-transparent text-white h-10 w-full rounded-md px-3"
              />
            ...
            <div className='space-y-2'>
              <p className="text-[#FAFAFA] text-sm">Subject</p>
              <input
                type="text"
                className="border border-[#262626] bg-transparent text-white h-10 w-full rounded-md px-3"
              />
        ...
        <div className="flex-1">
          <div className="border border-[#EBEBEB80] bg-[#1F1F1F] rounded-lg p-6 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl text-[#FAFAFA] font-semibold">Location & Availability</h3>
            </div>
            <p className="text-sm text-[#D9D9D9]">Based in San Francisco, CA</p>
      ...
      <div className="w-full max-w-4xl space-y-8 md:pt-48 pt-10">
        <div className="text-center space-y-5">
          <h3 className="text-2xl text-[#FAFAFA] font-semibold">Frequently Asked Questions</h3>
          <p className="text-sm text-[#D9D9D9]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {faqs.map((faq, i) => (
            <div key={i} className="space-y-2 rounded-lg ">
              <p className="text-[#FAFAFA] text-base font-medium">{faq.question}</p>
              <p className="text-[#D9D9D9] text-sm leading-6">{faq.answer}</p>
            </div>
          ))}
        </div>
      </div>
